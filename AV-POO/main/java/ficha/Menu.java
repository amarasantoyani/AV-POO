...
import static ficha.AvaliacaoOO2022.*;
import java.util.Scanner;
import java.util.ArrayList;
import java.util.InputMismatchException;
import java.util.List;
import static ficha.Personagem.*;
import racasClasses.*;

//CLASSE ALTERADA PARA AV
...
public class Menu {
    ...
    public static void exec(){
        Scanner ler = new Scanner(System.in);   //aqui foi alterado. Interação com o usuário, recebe os valores de nome, matricula e nota.
        ...
        try{
            ...
            try{
                ...
                nota = ler.nextFloat();
                av.setNota(nota);
            }catch(InputMismatchException AvaliacaoOO2022NaoInformadaException){
        ...
        }catch(IllegalArgumentException AvaliacaoOO2022NaoInformadaException){
            System.out.println("A exceção AvaliacaoOO2022NaoInformadaException foi lançada");
        }
        salvaArq(av);
